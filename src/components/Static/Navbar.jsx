...
export default function Navbar() {
  ...
  const navBase = "absolute md:fixed inset-x-0 top-0 z-50 transition-all duration-300";
  ...
  if (loading) {
    return (
      <nav className="absolute md:fixed inset-x-0 top-0 z-50 h-16 bg-white border-b border-gray-200" />
    );
  }
